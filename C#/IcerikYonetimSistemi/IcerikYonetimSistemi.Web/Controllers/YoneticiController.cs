...
namespace IcerikYonetimSistemi.Web.Controllers
{
	...
	public class YoneticiController : Controller
	{
		...
		[HttpPost]
		[ValidateAntiForgeryToken]
		public ActionResult SayfaIcerikDuzenle(SayfaIcerik sayfaIcerik)
		{
			if (ModelState.IsValid)
			{
				SayfaIcerik icerik = sayfaIcerikIslemleri.Bul(x => x.SayfaIcerikID == sayfaIcerik.SayfaIcerikID);
				...
				return RedirectToAction("SayfaIcerik", new { sayfaId = icerik.SayfaID, icerikId = icerik.SayfaIcerikID });
			}
		...
		{
			sayfaIcerikIslemleri.Sil(sayfaIcerikIslemleri.Bul(x => x.SayfaID == sayfaId && x.SayfaIcerikID == icerikId));
		...
		public ActionResult SayfaAltIcerikDuzenle(int? sayfaId, int? icerikId, int? altId, SayfaAltIcerik sayfaAltIcerik)
		{
			if (ModelState.IsValid)
			{
				SayfaAltIcerik altIcerik = sayfaAltIcerikIslemleri.Bul(x => x.SayfaAltIcerikID == sayfaAltIcerik.SayfaAltIcerikID);
