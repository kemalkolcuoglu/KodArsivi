...
namespace QRWebCMS.Web.Areas.Yonetici.Controllers
{
    public class PanelController : Controller
    {
        ...
        [YoneticiHataFilter]
        [YetkiFilter]
        public ActionResult OnKayitFormlari()
        {
            return View(Tanimlamalar.kayitIslemleri.VeriGetir("1 = 1 Order By KayitGonderimTarihi Desc"));
        }

        [YoneticiHataFilter]
        [YetkiFilter]
        public ActionResult OnKayitFormu(int id)
        {
            return View(Tanimlamalar.kayitIslemleri.Bul("KayitID = " + id));
        }
    }
}
