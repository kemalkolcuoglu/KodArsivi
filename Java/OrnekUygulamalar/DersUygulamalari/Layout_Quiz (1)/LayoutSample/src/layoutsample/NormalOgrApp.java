...
public class NormalOgrApp extends javax.swing.JFrame {

    /**
     * Creates new form IkinciOgr
     */
    public NormalOgrApp() {
        initComponents();
        ...
        for (int i = 0; i < 16; i++) {
            ...
            jPanel2.add(btn);
            JTextField lbl = new JTextField(value);
            jPanel1.add(lbl);
        }
    }
    ...
    private void initComponents() {
        ...
        jPanel2.setPreferredSize(new java.awt.Dimension(307, 483));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NormalOgrApp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new NormalOgrApp().setVisible(true);
            }
        });
    }
